...
GameState.prototype.preload = function() {
    ...
    this.game.load.image('playerMoon', 'assets/images/skater.png');
...
GameState.prototype.update = function() {
    ...
    //this.game.physics.arcade.overlap(this.player, this.name);
    ...
    if (checkOverlap(this.player, this.name))
    {
        //this.game.physics.arcade.collide(this.player, this.name);
    }
    else
    {
    ...
    if (onTheGround) {
        ...
        this.player.body.drag.setTo(this.DRAG*.3, 0); // x, y
    }
...
var game = new Phaser.Game(document.getElementById('container').offsetWidth, document.getElementById('container').offsetHeight, Phaser.AUTO, 'container', true, true, 'nearest-neighbor');
